...
#### После успешного развертывания смело открываем новую вкладку консоли (командная строка в Windows или bash в Linux/MacOS) и курлим (curl) как в примерах ниже
